...
- Seller and group leader can create Printify orders. Their order UI shows the assigned shop name and removes the shop picker.
- Backend blocks missing assignments and ignores/rejects non-admin shop spoofing before any Printify request.
...
| 3 | [Account-scoped Printify integration](./phase-03-account-scoped-printify-integration.md) | Pending |
